...
export default function UserProfile() {
    ...
    const editIcon =
        <>
            <Text color="whitesmoke" as={'span'} fontSize="1.5vw"
                fontWeight='semibold' mr="5%" px="1%" pt="0.5%"
                onClick={toggleEdit} className="cursorPointer"
                bg="rgba(57, 164, 164, 0.8)" borderRadius="4px">
                <EditIcon />
                Edit bio
            </Text>
        </>
    ...
    const profileBio =
        <>
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.800'}
                p="1%" fontWeight='semibold' bg="rgba(200, 220, 220, 0.6)"
                borderRadius="5px" whiteSpace={'pre-wrap'} minH="10vw">
                {userBio}
            </Text>
        </>
    ...
    const editBio =
        <>
            <Textarea fontSize={{ base: 'md', lg: 'lg' }} color={'gray.800'}
                minH="10vw" type='text' value={editVal} placeholder={userBio}
                onChange={(e) => setEditVal(e.target.value)} fontWeight='semibold'
                bg="rgba(200, 220, 220, 0.6)" borderRadius="5px" p="1%" />
            <Flex justify='space-between'>
                <Button onClick={saveBio} rounded={'full'} bg={'teal.500'}
                    color={'white'} _hover={{ bg: 'blue.400', }} w="15%" m="1%">
                    Save
                </Button>
                <Button onClick={closeEdit} rounded={'full'} bg={'teal.500'}
                    color={'white'} _hover={{ bg: 'blue.400', }} w="15%" m="1%">
                    Cancel
                </Button>
            </Flex>
                ...
                <Flex flexDir='column' justify='space-between' align='center' w="48%"
                    ...
                    <Flex flexDir='column' align='center' w={'full'} maxW={'lg'}>
                        ...
                        <Flex flexDir="column" mt="2%">
                            <Flex>
                                <Text fontSize={{ base: '2vw', lg: 'lg' }}
                                    color={'gray.800'} fontWeight='semibold'>
                                    Email: &nbsp;
                                </Text>
                                <Text fontSize={{ base: '2vw', lg: 'lg' }}
